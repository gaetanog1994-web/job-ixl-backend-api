...
if (!DATABASE_URL && !ENABLE_TEST_DB_BYPASS)
...
export const supabaseAdmin = createClient(process.env.SUPABASE_URL ?? "http://127.0.0.1:54321", process.env.SUPABASE_SERVICE_ROLE_KEY ?? "test-service-role-key", { auth: { persistSession: false, autoRefreshToken: false } });
